namespace hackathon_2019.Models
{
    ...
    using Syncfusion.Server.Base.BoldWebService;
    using System;
    using System.Net;
    using System.Web;
    ...
    public class AccountModel
    {
        ...
        public SyncfusionLoginResponse ValidateSyncfusionUser(string email, string password, string remember, string ipAddress, string host, string clientId = null)
        {
            ...
            try
            {
                ...
                if (syncfusionUserDetails.StatusCode == (int)HttpStatusCode.OK && syncfusionUserDetails.IsActivated)
                {
                    ...
                    SetLoginCookies(userData, remember != null && remember.ToLower().Trim() == "true", DirectoryType.Syncfusion, ipAddress, host, clientId);
        ...
        public void SetLoginCookies(Users userDetail, bool isPersistent, DirectoryType directoryType, string ipAddress = null, string host = null, string clientId = null)
        {
        ...
        public void UpdateSession(Users userInfo)
        {
